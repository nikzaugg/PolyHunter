#ifndef B_PERLIN_NOISE_2D_H
#define B_PERLIN_NOISE_2D_H
...
private:
	...
	*/
	const int _permutation[256] = { 151,160,137,91,90,15,
	...
	*/
	...
	float cosineInterpolate(float a, float b, float mu);

	float grad(int hash, float x, float z);
};
#endif /* defined(B_PERLIN_NOISE_2D_H) */
